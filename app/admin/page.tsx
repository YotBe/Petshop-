...
export default function AdminPage() {
    ...
    return (
      <div className="container max-w-md py-20 text-center">
        ...
        <p className="mt-2 text-slate-600">
          Set the <code className="font-mono text-xs">admin_pw</code> cookie to your
          <code className="font-mono text-xs"> ADMIN_PASSWORD</code> to access this page.
        </p>
  ...
  return (
    <div className="container py-10">
      ...
      <p className="mt-1 text-slate-600">{MOCK_ORDERS.length} orders awaiting fulfillment.</p>
          ...
          <div key={order.id} className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-md bg-slate-50 p-3">
                <h3 className="text-xs font-semibold uppercase text-slate-500">Customer</h3>
              ...
              <div className="rounded-md bg-slate-50 p-3">
                <h3 className="text-xs font-semibold uppercase text-slate-500">Items</h3>
                <ul className="mt-1 space-y-2">
                  {order.lines.map((line) => (
                    <li key={line.productId} className="flex items-center justify-between gap-2 text-sm">
                      ...
                      >
                        Fulfill on AliExpress <ExternalLink className="h-3 w-3" />
                      </a>
                    </li>
                  ))}
                </ul>
