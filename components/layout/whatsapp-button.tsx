...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 md:bottom-6 end-4 md:end-6 z-40 inline-flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-4 ring-white/40 transition active:scale-95 hover:scale-105 touch-manipulation"
    >
